...
public class CustomDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            layout = inflater.inflate(R.layout.mdialog, null);
        ...
        public CustomDialog createSingleButtonDialog() {
            showSingleButton();
            layout.findViewById(R.id.cancel).setOnClickListener(singleButtonClickListener);
            //如果传入的按钮文字为空，则使用默认的“返回”
            if (singleButtonText == null) {
                ((Button) layout.findViewById(R.id.cancel)).setText(R.string.cancel);
            }
            create();
            return dialog;
        }
